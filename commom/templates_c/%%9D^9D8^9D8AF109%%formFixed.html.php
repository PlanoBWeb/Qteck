<?php /* Smarty version 2.6.12, created on 2016-03-04 10:27:34
...
commom/img/icon-form.png" class="pull-left" alt="Fale Conosco" title="Fale Conosco">
    ...
    <div class="col-xs-12 col-sm-2 col-md-2 pull-right pd-mobile-form-home">
        <button type="submit" class="btn btn-default-site btn-default pull-right" onclick="return enviardadosFixed();">enviar!</button>
    </div>  
</form> 